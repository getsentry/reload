...
/***/ function(module, exports, __webpack_require__) {
	...
	var getAnonId = function getAnonId() {
	    var anonId = (0, _jsCookie.get)('anonId');
	    if (!anonId) {
	        anonId = generateUUID();
	        (0, _jsCookie.set)('anonId', anonId);
	    }
	    return anonId;
	};
	...
	var page = function page(extraData) {

	    var user_id = (0, _jsCookie.get)('gsId');
	    var anonymous_id = getAnonId();
	...
	window.ra = { page: page, endpoint: endpoint };
